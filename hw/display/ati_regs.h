...
#define PM4_STAT_FIFOCNT_MASK                   0x00000fff
#define PM4_STAT_BUSY                           (1 << 16)
#define PM4_STAT_GUI_ACTIVE                     (1u << 31)
...
/*
 * GUI scratch registers. Plain read/write storage in the GUI block, used
 * by drivers as an engine-alive handshake: a value is pushed through the
 * command stream (CCE ring or PIO FIFO) and then polled back over MMIO to
 * confirm the stream really executed.
 */
...
/* 3D texture unit, context block (r128_reg.h R128_*_C) */
...
#define SEC_TEX_PITCH_SHIFT                      16
#define SEC_TEX_SIZE_SHIFT                       20
#define SEC_TEX_HEIGHT_SHIFT                     24
#define MISC_3D_STATE_CNTL_REG_C                0x1ca0

/* Alpha blend factors, MISC_3D_STATE_CNTL_REG bits 19:16 and 23:20 */
#define ALPHA_BLEND_SRC_SHIFT                   16
#define ALPHA_BLEND_DST_SHIFT                   20
#define ALPHA_BLEND_MASK                        0xf
#define ALPHA_BLEND_ZERO                        0
#define ALPHA_BLEND_ONE                         1
#define ALPHA_BLEND_SRCCOLOR                    2
#define ALPHA_BLEND_INVSRCCOLOR                 3
#define ALPHA_BLEND_SRCALPHA                    4
#define ALPHA_BLEND_INVSRCALPHA                 5
#define ALPHA_BLEND_DSTALPHA                    6
#define ALPHA_BLEND_INVDSTALPHA                 7
#define ALPHA_BLEND_DSTCOLOR                    8
#define ALPHA_BLEND_INVDSTCOLOR                 9

/* TEX_CNTL_C bit 9 enables alpha blending */
#define TEX_CNTL_ALPHA_ENABLE                   (1 << 9)

/* TEX_SIZE_PITCH_C: each field is a log2 value in a nibble */
#define TEX_PITCH_SHIFT                         0
#define TEX_SIZE_SHIFT                          4
#define TEX_HEIGHT_SHIFT                        8

/* PRIM_TEX_CNTL_C texel format, bits 19:16 */
#define TEX_DATATYPE_SHIFT                      16
#define TEX_DATATYPE_MASK                       (0xf << 16)
#define TEX_DATATYPE_CI8                        2
#define TEX_DATATYPE_ARGB1555                   3
#define TEX_DATATYPE_RGB565                     4
#define TEX_DATATYPE_RGB888                     5
#define TEX_DATATYPE_ARGB8888                   6
#define TEX_DATATYPE_RGB332                     7
#define TEX_DATATYPE_Y8                         8
...
/*
 * PM4_BUFFER_CNTL mode field (bits 31:28). Real hardware supports mixed
 * PIO/bus-master/vertex-cache ring configurations; only 192PIO (pure PIO,
 * ring lives directly in VRAM) is implemented by ati_cce_process() so
 * far. The BM-prefixed modes mean some or all ring entries are pointers
 * to indirect command buffers fetched via DMA from system/AGP memory -
 * not yet emulated.
 */
#define PM4_BUFFER_CNTL_MODE_MASK                0xf0000000
#define PM4_BUFFER_CNTL_NONPM4_MODE              (0  << 28)
#define PM4_BUFFER_CNTL_192PIO                   (1  << 28)
#define PM4_BUFFER_CNTL_192BM                    (2  << 28)
#define PM4_BUFFER_CNTL_128PIO_64INDBM           (3  << 28)
#define PM4_BUFFER_CNTL_128BM_64INDBM            (4  << 28)
#define PM4_BUFFER_CNTL_64PIO_128INDBM           (5  << 28)
#define PM4_BUFFER_CNTL_64BM_128INDBM            (6  << 28)
#define PM4_BUFFER_CNTL_64PIO_64VCBM_64INDBM     (7  << 28)
#define PM4_BUFFER_CNTL_64BM_64VCBM_64INDBM      (8  << 28)
#define PM4_BUFFER_CNTL_64PIO_64VCPIO_64INDPIO   (15 << 28)
#define PM4_192PIO_RING_DWORDS                   192

/* CCE packet header format (type in top 2 bits of the header dword) */
#define CCE_PACKET_TYPE_MASK                     0xc0000000
#define CCE_PACKET0                              0x00000000
#define CCE_PACKET1                              0x40000000
#define CCE_PACKET2                              0x80000000
#define CCE_PACKET3                              0xc0000000
#define CCE_PACKET0_ONE_REG_WR                   0x00008000
#define CCE_PACKET_COUNT_MASK                    0x3fff0000
#define CCE_PACKET0_REG_MASK                     0x000007ff
#define CCE_PACKET1_REG0_MASK                    0x000007ff
#define CCE_PACKET1_REG1_MASK                    0x003ff800

/* Packet3 opcodes, extracted as (header >> 8) & 0xff */
#define CCE_PACKET3_OP_NOP                       0x10
#define CCE_PACKET3_OP_PAINT                     0x11
#define CCE_PACKET3_OP_BITBLT                    0x12
#define CCE_PACKET3_OP_SMALLTEXT                 0x13
#define CCE_PACKET3_OP_HOSTDATA_BLT              0x14
#define CCE_PACKET3_OP_POLYLINE                  0x15
#define CCE_PACKET3_OP_SCALING                   0x16
#define CCE_PACKET3_OP_TRANS_SCALING             0x17
#define CCE_PACKET3_OP_POLYSCANLINES             0x18
#define CCE_PACKET3_OP_NEXT_CHAR                 0x19
#define CCE_PACKET3_OP_PAINT_MULTI               0x1a
#define CCE_PACKET3_OP_BITBLT_MULTI              0x1b
#define CCE_PACKET3_OP_PLY_NEXTSCAN              0x1d
#define CCE_PACKET3_OP_SET_SCISSORS              0x1e
#define CCE_PACKET3_OP_SET_MODE24BPP             0x1f
#define CCE_PACKET3_OP_3D_SAVE_CONTEXT           0x20
#define CCE_PACKET3_OP_3D_PLAY_CONTEXT           0x21
#define CCE_PACKET3_OP_3D_RNDR_GEN_INDX_PRIM     0x23
#define CCE_PACKET3_OP_3D_RNDR_GEN_PRIM          0x25
#define CCE_PACKET3_OP_LOAD_PALETTE              0x2c
#define CCE_PACKET3_OP_PURGE                     0x2d
#define CCE_PACKET3_OP_NEXT_VERTEX_BUNDLE        0x2e
/* CNTL_* variants of the 2D ops above carry an extra leading state dword
 * and are encoded with bit 0x80 set relative to their base opcode. */
#define CCE_PACKET3_OP_CNTL_BIT                  0x80

/* PM4_VC_FORMAT: vertex format flags (which per-vertex fields are
 * present and in what order in the vertex stream) */
...
/* PM4_VC_CNTL: primitive type/walk mode/vertex count for a 3D draw */
#define CCE_VC_CNTL_PRIM_TYPE_MASK               0x0000000f
...
#define CCE_VC_CNTL_PRIM_WALK_MASK                0x00000030
...
#define CCE_VC_CNTL_NUM_SHIFT                     16
